...
bool GrapherTests::testGraficarEscenario800x600(void)
{
	XmlElement elementoEscenario("escenario", 1, 1000);
	XmlAttribute atributoNombreEscenario("nombre", "Nivel de Prueba 800x600");
	elementoEscenario.addAttribute(atributoNombreEscenario);
...
bool GrapherTests::testGraficarEscenario1024x768(void)
{
	XmlElement elementoEscenario("escenario", 1, 1000);
	XmlAttribute atributoNombreEscenario("nombre", "Nivel de Prueba 1024x768");
	elementoEscenario.addAttribute(atributoNombreEscenario);
